...
class RPI_MAIN(threading.Thread):
        ...
        def __init__(self):
                ...
                while not (self.algo_thread.is_algo_connected() and self.IR_thread.is_IR_connected()):
                        time.sleep(10)

        #######################IR################################
        def writeIR(self, img):
                self.IR_thread.write(img)
                print('Write to IR: {}'.format(img))
        
        def readIR(self):
                try:
                        while True:
                                IRmsg = self.IR_thread.read()
                                print('Read from IR: {}'.format(IRmsg))
                                if IRmsg is not '':
                        ...
                        if 'NoneType' in str(e):
                                ...
                                p.error('Read Error from IR: {}'.format(e))
        ...
        def readAlgo(self):
                try:
                        while True:
                                ...
                                print('Step: {}, Read from Algo: {}'.format(self.steps, AlgoMsg))
        ...
        def writeAlgo(self, msg):
                ...
                print('Write to Algo: {}'.format(msg))
                ...
                while True:
                        ...
                        try:
                                while True:
                                        ...
                                        print('Read from BT: {}'.format(BTmsg))
                                        if 'B3:' in BTmsg:
        ...
        def readArduino(self):
                try:
                        while True:
                                ...
                                print('Read from Arduino: {}'.format(ARDmsg))
                                if 'A2:' in ARDmsg:
        ...
        def writeArduino(self, msg):
                ...
                self.IR_lock.release()
                print('Write to Arduino: {}'.format(msg))
